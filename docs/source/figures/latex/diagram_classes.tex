...
\umlusecase[x=0, y=-4.5, anchor=north, name=Gates, width=7em]{\textbf{\small subclasses} \\ \textmd{\texttt{Pauli \\ GellMann \\ Rotation \\ Phase \\ Diagonal \\ Swap \\ Summation \\ Not \\ Hadamard \\ Fourier \\ Measurement}}}
