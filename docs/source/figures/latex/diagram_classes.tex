...
\umlusecase[x=-3, y=2.25, name=QuantitiesMixin, width=7em]{\textmd{\texttt{OperationsMixin}}}
\umlusecase[x=-3, y=1.5, name=OperationsMixin, width=7em]{\textmd{\texttt{QuantitiesMixin}}}
\end{umlsystem}
...
\umlusecase[x=0, y=-4.5, anchor=north, name=Gates, width=7em]{\textbf{\small subclasses} \\ \textmd{\texttt{Unitary \\ Pauli \\ GellMann \\ Rotation \\ Phase \\ Diagonal \\ Swap \\ Summation \\ Not \\ Hadamard \\ Fourier \\ Measurement}}}
...
\umluniaggreg[geometry=-|, anchor2=-30, draw=relationcolor, line width=\relationwidth]{DiagramColumn}{DiagramCell}
\umluniaggreg[geometry=-|, anchor2=-30, draw=relationcolor, line width=\relationwidth]{DiagramCircuit}{DiagramColumn}
...
\umlVHVdep[geometry=|-|, anchor1=20, anchor2=-90, draw=relationcolor, line width=\relationwidth]{QuantumObject}{VisualizationMixin}
...
\umlinherit[geometry=|-|, weight=0.35, anchor1=90, anchor2=-160, draw=relationcolor, line width=\relationwidth]{QuantumState}{QuantumObject}
\umlinherit[geometry=|-|, weight=0.35, anchor1=168.75, anchor2=-90, draw=relationcolor, line width=\relationwidth]{QuantumGate}{QuantumObject}
