...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=west,xshift=-0.5cm,yshift=-4.00cm,rotate=0, scale=1.35, color=fontcolor] at (0,0) {\textbf{and performing general quantum information processing \& computation}};
