...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=north west,xshift=-0.5cm,yshift=0.5cm,rotate=0, scale=0.635, color=fontcolor] at (0,0) {\includegraphics{logo-text.pdf}};
    \node[anchor=west,xshift=-0.5cm,yshift=-3.25cm,rotate=0, scale=1.35, color=fontcolor] at (0,0) {\textbf{A Python package for studying quantum models of closed timelike curves}};
    \node[anchor=west,xshift=-0.5cm,yshift=-4.00cm,rotate=0, scale=1.35, color=fontcolor] at (0,0) {\textbf{and simulating general quantum information processing \& computation}};
