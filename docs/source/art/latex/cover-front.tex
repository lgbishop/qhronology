...
\begin{tikzpicture}[remember picture, overlay]
    \begin{scope}[xshift=9.2825cm, yshift=-17.75cm, scale=4.5, rotate=45, xshift=0cm, yshift=0cm]
    \begin{axis}[
    %hide axis,
    anchor=center,
    %axis equal image,
    ...
    \node[anchor=center,xshift=\eval{7.8825 + 0.125*\ClockPositionAmplitudeHorizontal*\ClockShiftHorizontal} cm,yshift=\eval{-16.35 - 0.125*\ClockPositionAmplitudeVertical*\ClockShiftVertical} cm,rotate=45, opacity=1] at (0,0) {\includegraphics[height=6.5cm]{render-clock-fixed.png}};
    ...
    \node[anchor=north west,xshift=-1.00cm,yshift=0.5cm,rotate=0, scale=0.695, color=fontcolor] at (0,0) {\includegraphics{logo-text.pdf}};
    \node[anchor=west,xshift=-1.00cm,yshift=-3.75cm,rotate=0, scale=1.485, color=fontcolor] at (0,0) {\textbf{A Python package for studying quantum models of closed timelike curves}};
    \node[anchor=west,xshift=-1.00cm,yshift=-4.45cm,rotate=0, scale=1.485, color=fontcolor] at (0,0) {\textbf{and simulating general quantum information processing \& computation}};
    \node[anchor=west,xshift=-1.25cm,yshift=-6cm,rotate=0, scale=3, color=fontcolor] at (0,0) {\textbf{Documentation,}};
    \node[anchor=west,xshift=-1.25cm,yshift=-7.5cm,rotate=0, scale=3, color=fontcolor] at (0,0) {\textbf{Examples,}};
    \node[anchor=west,xshift=-1.25cm,yshift=-9cm,rotate=0, scale=3, color=fontcolor] at (0,0) {\textbf{and Theory}};
