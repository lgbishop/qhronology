...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=west,xshift=-0.5cm,yshift=-3.25cm,rotate=0, scale=1.45, color=fontcolor] at (0,0) {\textbf{A Python package for resolving quantum time-travel paradoxes and}};
    \node[anchor=west,xshift=-0.5cm,yshift=-4.00cm,rotate=0, scale=1.45, color=fontcolor] at (0,0) {\textbf{performing general quantum information processing \& computation}};
