...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=west,xshift=0.75cm,yshift=-8.575cm,rotate=0,yshift=-2cm, scale=1.15, color=fontcolor] at (0,0) {\contour{fontcolor}{A Python package for studying quantum models of closed timelike curves}};
    \node[anchor=west,xshift=0.75cm,yshift=-9.15cm,rotate=0,yshift=-2cm, scale=1.15, color=fontcolor] at (0,0) {\contour{fontcolor}{and performing general quantum computation \& information processing}};
    }
\end{tikzpicture}
