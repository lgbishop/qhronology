...
\pgfplotsset{
    colormap={customcolormap}{[1cm]rgb255(0cm)=(24,115,255); rgb255(1cm)=(30,144,255); rgb255(2cm)=(120,188,255); rgb255(5cm)=(210,232,255); rgb255(8cm)=(210,232,255)},
...
\begin{tikzpicture}[remember picture, overlay]
    \begin{scope}[xshift=7.425cm, yshift=-2.15cm, scale=3.25, rotate=0, xshift=0cm, yshift=0cm]
    \begin{axis}[
    %hide axis,
    anchor=center,
    %axis equal image,
    ...
    \end{scope}
    \IfFileExists{./clock-distorted.png}{ % True
    \node[anchor=center,xshift=7.425cm,yshift=-2.35cm,rotate=0, opacity=1] at (0,0) {\includegraphics[height=4.15cm]{clock-distorted.png}};
    }{ % False
    \node[anchor=center,xshift=\eval{7.425 + 0.15*\ClockPositionAmplitudeHorizontal*\ClockShiftHorizontal} cm,yshift=\eval{-2.35 + 0.35*\ClockPositionAmplitudeVertical*\ClockShiftVertical} cm,rotate=0, opacity=1] at (0,0) {\includegraphics[height=4.15cm]{logo-clock-fixed.png}};
    ...
    \node[anchor=west,xshift=0.15cm,yshift=-6.575cm,rotate=0,yshift=-2cm, scale=1.15, color=fontcolor] at (0,0) {A Python package for studying quantum models of closed timelike curves};
    \node[anchor=west,xshift=0.15cm,yshift=-7.15cm,rotate=0,yshift=-2cm, scale=1.15, color=fontcolor] at (0,0) {and performing general quantum computation \& information processing};
    }
\end{tikzpicture}
