...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=west,xshift=0.15cm,yshift=-6.575cm,rotate=0,yshift=-2cm, scale=1.15, color=fontcolor] at (0,0) {A Python package for resolving quantum time-travel paradoxes};
