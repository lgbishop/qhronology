...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=west,xshift=0.15cm,yshift=-7.15cm,rotate=0,yshift=-2cm, scale=1.15, color=fontcolor] at (0,0) {and simulating general quantum information processing \& computation};
    }
\end{tikzpicture}
