...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=west,xshift=-0.2cm,yshift=-3.215cm,rotate=0, scale=1.015, color=fontcolor] at (0,0) {\contour{fontcolor}{and simulating general quantum information processing \& computation}};
    }
\end{tikzpicture}
