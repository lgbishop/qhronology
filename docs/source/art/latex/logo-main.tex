...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=center,xshift=5.525cm,yshift=-1.165cm,rotate=0, scale=0.435, color=fontcolor] at (0,0) {\includegraphics{logo-text.pdf}};
    \node[anchor=west,xshift=-0.2cm,yshift=-2.700cm,rotate=0, scale=1.015, color=fontcolor] at (0,0) {\contour{fontcolor}{A Python package for studying quantum models of closed timelike curves}};
    \node[anchor=west,xshift=-0.2cm,yshift=-3.215cm,rotate=0, scale=1.015, color=fontcolor] at (0,0) {\contour{fontcolor}{and performing general quantum information processing \& computation}};
    }
\end{tikzpicture}
