...
.. raw:: latex
   ...
   % Disable footnotes in bibliography.
   \makeatletter
   \renewenvironment{footnote}[1][]{}
   \makeatother
   \renewcommand{\sphinxnolinkurl}[1]{}
