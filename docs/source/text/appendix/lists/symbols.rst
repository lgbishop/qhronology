...
.. csv-table:: List of symbols.
   ...
   ":math:`\Control^\alpha \Anticontrol^\beta \Unitary^\gamma`", "controlled-anticontrolled-unitary gate (indices: :math:`\alpha=` control, :math:`\beta=` anticontrol, :math:`\gamma=` unitary)"
