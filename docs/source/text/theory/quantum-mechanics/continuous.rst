...
.. math:: \mathcal{T}[\op{A}_1(\Time_1)\cdot \op{A}_2(\Time_2)\cdot\ldots\cdot \op{A}_n(\Time_n)] = \op{A}_{i_1}(\Time_{i_1})\cdot \op{A}_{i_2}(\Time_{i_2})\cdot\ldots\cdot \op{A}_{i_n}(\Time_{i_n}), \quad \Time_{i_1}\geq \Time_{i_2}\geq\ldots\geq \Time_{i_n}.
