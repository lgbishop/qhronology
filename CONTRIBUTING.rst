...
Acceptance of the CLA is achieved by reading the document itself (`CLA.txt <https://github.com/lgbishop/qhronology/blob/latest/licenses/CLA.txt>`_), and then declaring your agreement to its terms and conditions by reproducing, in the description of any merge requests to the project's repository, the following statement:
...
The Qhronology project is committed to making contributions available as *free and open-source software* (FOSS) under an OSI-approved license of some form. Currently, this is achieved by offering the project as free for non-commercial use with the GNU Affero General Public License v3.0 (AGPL-3.0-or-later). The main reason of the CLA therefore is that Qhronology needs permission from contributors in order to be able to redistribute their contributions under a non-AGPL license. Accepting the CLA is simply a way of legally declaring that you have both the necessary ownership of the contributions and actually do grant the project the rights to use them. Such contributions include adding to or changing any of the project's following facets:
...
If any of these actions are performed, the conditions of the agreement at the time of acceptance of the CLA will not change.
